...
export function ProjectCard({
  ...
  return (
    <TiltCard className={`project-card ${project.featured ? "featured" : ""}`}>
      <button className="project-image-button" onClick={() => onOpen(project)} aria-label={`Explore ${project.title}`}><ProjectVisual project={project} available={imageAvailable} /><span className="image-explore">Explore Project <ArrowUpRight size={16}/></span></button>
